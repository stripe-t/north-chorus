...
soprano = \relative c' {
  ...
  \dynamicUp
  \mark #1
  r4 aes\p ees' aes | f2. r4 | r aes, des aes' | fes1\espressivo ~ |
  \tempo \markup {
      \concat {
        \smaller \note #"4" #1
        \normal-text
  ...
  \mark #2
  R1*4 |
  r4 aes,\mp ees' aes | f2. r4 | r aes, des aes' | ees2.\< r4\! | r2 r8 \mark #3 ees\mf ees ees |
  f ees f ees r ees ees ees | f ees f ees r ees ees f | ges f ges f b, c f ees | ees des ees des r des des des |
  ees des ees des r des des ees | des c des c r c c des | c bes bes aes aes g g aes | bes2 r8 \mark #4 c'\mp c c |
  ...
  des c des c r c c c | des c des c r c c des | ees des ees des a bes des c | c bes c des r2 |
  des1\mp( | c2 ees4 c | bes1 | aes4) r \mark #10 gis,8\mf ais b cis |
  \bar "||" \key b \major
  dis4 cis b cis8 dis ~ | dis fis gis cis b4 r8 cis | dis4 cis b8 b fis' fis ~ | fis dis16 cis dis4 r2 |
  ...
  \bar "||" \key a \major
  \mark #17
  r a,4\mf e' a | fis2. r4 | r4 a, d a' | e2. r4 |
  r a,4 e' a | fis2. r4 | r4 a, d a' | e2.^\markup{\italic "poco"}\< r4\! |
  R1 | <cis e>1\p ~ | q\fermata\> <>\! \bar "|."
}
sopranolyric = \lyricmode {
  ...
  \noim Ah __
  \im オッ ケー ちょっ と \noim Ah __
  \im こ い ー し て る しゅ ん か ん きっ と だ れ か を か ん じ て る ー
...
tenor = \relative c {
  ...
  f ees f ees r ees ees ees | f ees f ees r ees ees f | ges f ges f b, c f ees | ees des ees des r2 |
  fes2(\mp aes4 bes | c2 ees,) | f1( | aes2 g) |
  ...
  r8 dis\mp dis dis fisis gis ais cis | cis b b ais b4 r | R1 | R1 |
  r8 fisis\mf\< fisis fisis fisis gis ais cis | cis b b ais b4\! dis,8\cresc dis | gis gis gis b b b b b | cis cis dis dis <cis eis> q q e | r d ~ d2.\< | eis4->\ff eis-> r2 |
      ...
      \new Staff = "SoloWrap" \with {
        ...
        \new Staff = "Solo" \with {
          ...
          \new Voice = "SoloVoice" \relative c''{
            ...
            r2 r4 dis8 cis ~ | cis cis b b ais ais gis fis | ais b c cis ais fis gis fis ~ | fis2.^\markup {\italic "accel."} r4 \stopStaff | 
          }
        }
      }
